...
An interactive Telegram bot for English learners built with **FastAPI** and **python-telegram-bot (v21+ async)**, featuring **Gemini Flash AI coaching**, an instant **curated offline fallback bank** (108 exercises), and ready for zero-maintenance deployment on **Vercel Serverless Functions**.
...
- ⚡ **Hybrid AI Engine:** Real-time feedback and dynamic exercise generation via Google Gemini Flash; automatically falls back to offline exercises if offline or unconfigured.
...
Point Telegram to your Vercel deployment URL:
```bash
...
├── gemini_service.py   # Gemini Flash AI integration & coach persona
