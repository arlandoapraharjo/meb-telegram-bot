...
const DEFAULT_TRACKS: LearningTrack[] = [
  {
    ...
    description: "Realistic café, travel, and casual dialogue scenarios with CEFR-graded feedback.",
    level: "A1–C1",
    badgeText: "Roleplay",
    icon: MessageSquare,
  },
  {
    ...
    description: "Daily high-frequency words, contextual definitions, idioms, and spaced repetition.",
    level: "All Levels",
    badgeText: "Lexicon",
    icon: BookOpen,
  },
  {
    ...
    emoji: "✏️",
    title: "Grammar Lab",
    description: "Bite-sized tense formulas, common error corrections, and instant interactive quizzes.",
    level: "A1–B2",
    badgeText: "Rules",
    icon: PenTool,
  },
  {
    ...
    description: "Short cultural essays, news snippets, and active reading comprehension checks.",
    level: "B1–C2",
    badgeText: "Stories",
    icon: BookMarked,
  },
  {
    ...
    description: "Phonetic breakdowns, tongue twisters, and natural intonation challenges.",
    level: "A2–C1",
    badgeText: "Pronounce",
    icon: Mic,
  },
  {
    ...
    description: "Rapid-fire quizzes, daily streaks, grammar puzzles, and vocabulary mini-games.",
    level: "Adaptive",
    badgeText: "Gamified",
    icon: Trophy,
  },
